...
export interface ApiApplicationApplication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    appStatus: Schema.Attribute.Enumeration<
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::job.job'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'job.geo-location', false> &
      Schema.Attribute.Required;
    offer: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    openings: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    preference: Schema.Attribute.Enumeration<['employee', 'employer']>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
